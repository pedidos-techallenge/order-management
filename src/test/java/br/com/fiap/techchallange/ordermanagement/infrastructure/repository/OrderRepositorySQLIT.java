...
@Transactional
@ActiveProfiles("test")
@EnabledIf(expression = "#{environment['spring.database.sql.enabled'] == 'true'}")
public class OrderRepositorySQLIT {

    @Value("${spring.database.sql.enabled}")
    private boolean sqlEnabled;

    @Autowired
    private IOrderRepositorySQL orderRepository;
